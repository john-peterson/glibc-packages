...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS=" -DUSE_NGHTTP2=ON -DCURL_BROTLI=ON -DCURL_USE_LIBPSL=OFF -DOPENSSL_ROOT_DIR=$TERMUX_PREFIX/opt/boringssl -DBUILD_SHARED_LIBS=ON -DCMAKE_INSTALL_PREFIX=$TERMUX_PREFIX/opt/curl-impersonate  -DCMAKE_INSTALL_LIBDIR=$TERMUX_PREFIX/opt/curl-impersonate/lib "
